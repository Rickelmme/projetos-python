...
padx=7, relief=FLAT, anchor="e", justify=RIGHT, font=('Ivy 18'), bg=cor3, fg=cor2)
...
b_7 = Button(frame_corpo,command=lambda: entrar_valores('*'), text='x', width=5, height=2, bg=cor5, fg=cor2, font=('Ivy 13 bold'),\
relief=RAISED, overrelief=RIDGE)
